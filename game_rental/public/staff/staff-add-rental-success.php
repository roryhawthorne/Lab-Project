...
<?php $page_title = 'Rental Added Success'; ?>
...
<br/>
    <div class="container shadow-lg" style="background-color: white; padding: 2em; margin: auto; font-family: 'bungee', cursive; border-radius: 1em; height: 100%;">
        <div class="row">
            <h2 class"col-md-12" style="font-size: 3em; margin: auto;">retnal added successfully!</h2>
        </div>
        <div class="row">
            <br/>
        </div>
        ...
        <div class="row">        
            <div class="col-md-1"></div>
            <form action="<?php echo url_for('/staff/staff-add-rental.php'); ?>" class="col-md-5">
